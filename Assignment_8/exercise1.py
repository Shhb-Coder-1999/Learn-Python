...
class Fractional_Number :
    ...
    def simplify(self,f_num):  
        if(math.gcd(f_num.numerator, f_num.denumerator)!= 1 ) :
            return Fractional_Number(f_num.numerator/math.gcd(f_num.numerator, f_num.denumerator)  , f_num.denumerator/math.gcd(f_num.numerator, f_num.denumerator) )
        else :
            return Fractional_Number(f_num.numerator, f_num.denumerator)
        ...
        if __name__=='__main__':
            while(True):
                ...
                if option == 1:
                     ...
                     n1 , den1 = Get_Fractional_Number()
                     num1 = Fractional_Number(n1 , den1)
                     print("result : " , num1.simplify(num1))     
